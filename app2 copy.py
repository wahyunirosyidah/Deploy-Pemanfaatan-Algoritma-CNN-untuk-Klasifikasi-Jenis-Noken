...
model = load_model('mobilenetv2.h5')  # Sesuaikan nama file
classes = ['Bitu Agia', 'Junum Ese']  # Ganti dengan kelas yang sesuai

# Preprocessing untuk input gambar
...
# Tabs navigasi
tab1, tab2, tab3 = st.tabs(["🏷️ Klasifikasi Noken", "📚 Tentang Noken", "🏕️ Duta Noken"])
...
with tab1:
    ...
    if image:
        ...
        if st.button("💾 Simpan Hasil"):
            ...
            # Tambahkan logika simpan ke file/database jika dibutuhkan
...
# ======================== TAB 3: DUTA NOKEN ========================
with tab3:
    st.header("🏕️ Duta Noken")
    st.write("""
    **Duta Noken** adalah inisiatif untuk meningkatkan kesadaran, pelestarian, dan promosi budaya Papua, khususnya Noken.
    """)
    ...
    - 🌐 Website: [www.nokenpapua.id](https://www.nokenpapua.id) (simulasi)
    """)
